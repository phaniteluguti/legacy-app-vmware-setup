...
[java_servers]
$($script:java_vm_ip) ansible_user=$($script:vm_ssh_user) ansible_ssh_private_key_file=$keyPath

[dotnet_servers]
$($script:dotnet_vm_ip) ansible_user=$($script:vm_ssh_user) ansible_ssh_private_key_file=$keyPath

[php_servers]
$($script:php_vm_ip) ansible_user=$($script:vm_ssh_user) ansible_ssh_private_key_file=$keyPath
